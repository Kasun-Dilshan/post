...
export function GoldSavingPlanPage() {
  const items = useMemo(
    () => [
      { id: 'one-time', premium: 1000000, premiumLabel: 'Rs. 1,000,000 (One-time)', payment: 'Rs. 1,000,000 at 5 Years', maturityYear: '5 Years', maturityIllustrated: 5000000, maturityGuaranteed: 2500000, termMonths: 'N/A' },
      { id: '23m', premium: 30435, premiumLabel: 'Rs. 30,435 (23 Months) Pay 40% initially (400,000)', payment: 'Rs. 1,100,005 at 5.6 Years', maturityYear: '5.6 Years', maturityIllustrated: 5000000, maturityGuaranteed: 2500000, termMonths: 23 },
      { id: '36m', premium: 30556, premiumLabel: 'Rs. 30,556 (36 Months)', payment: 'Rs. 1,100,016 at 6 Years', maturityYear: '6 Years', maturityIllustrated: 5000000, maturityGuaranteed: 2500000, termMonths: 36 },
      { id: '48m', premium: 22920, premiumLabel: 'Rs. 22,920 (48 Months)', payment: 'Rs. 1,100,160 at 7 Years', maturityYear: '7 Years', maturityIllustrated: 5000000, maturityGuaranteed: 2500000, termMonths: 48 },
      { id: '60m', premium: 18335, premiumLabel: 'Rs. 18,335 (60 Months)', payment: 'Rs. 1,100,100 at 8 Years', maturityYear: '8 Years', maturityIllustrated: 5000000, maturityGuaranteed: 2500000, termMonths: 60 },
    ],
    [],
  )
      ...
      <style>{`
        ...
        body.inv-body{
          ...
          background:
            ...
            radial-gradient(800px 500px at 40% 105%, rgba(251,191,36,.10), transparent 60%),
        ...
        .inv-brand i{
          ...
          color:#fff;box-shadow: 0 14px 28px rgba(245,158,11,.22);
        }
        .inv-hero{
          margin-top:14px;
          border-radius:26px;
          ...
          border:1px solid var(--inv-stroke);
          background:
            radial-gradient(900px 450px at 10% 20%, rgba(245,158,11,.18), transparent 60%),
            radial-gradient(900px 450px at 90% 10%, rgba(14,167,106,.18), transparent 62%),
        ...
        .inv-kicker{
          ...
          background:rgba(245,158,11,.12);border:1px solid rgba(245,158,11,.18);
          color:#78350f;font-weight:900;text-transform:uppercase;letter-spacing:.7px;font-size:12px
        }
        ...
        .form-select:focus{
          ...
          box-shadow: 0 0 0 .25rem rgba(245,158,11,.18)!important;
        }
      ...
      <div className="container my-4 inv-body">
        ...
        <div className="inv-hero">
          <div className="inner">
            ...
            <h1 className="inv-title">Choose a premium and view the complete summary.</h1>
            <p className="inv-sub">
              Select a premium to see payment details, maturity values, term months, and the full breakdown table.
            </p>
          </div>
        </div>
